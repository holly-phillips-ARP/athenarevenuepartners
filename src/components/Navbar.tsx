  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-6 md:px-10 h-20 flex items-center justify-between">
        <a href="#" aria-label="Athena Revenue Partners" className="flex items-center -my-4">
          <img src={logo} alt="Athena Revenue Partners" className="h-20 md:h-24 w-auto" width={1024} height={1024} />
        </a>
